      ...
      <section className="bg-white mt-32 max-sm:mt-36">
        <div className="grid max-w-[90%] px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="text-primary max-w-2xl mb-4 text-3xl font-bold tracking-tight leading-none md:text-4xl xl:text-5xl">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-900 lg:mb-8 md:text-lg lg:text-xl ">
              ...
              here to help you achieve your health goals through professional
              tele-health consultations.
            </p>
            <a
              href="#"
              className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded bg-primary hover:bg-secondary border border-transparent max-sm:mb-2"
            >
              Get started
              <svg
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            ...
            >
              <defs>
                <linearGradient
                  id="ac3cc305-f6db-42f4-bbbd-32121ee27a74-79"
                  x1="403.57"
                  y1="833.5"
                  x2="403.57"
                  y2="218.16"
                ...
                <linearGradient
                  id="ad14f186-b27f-416c-b629-0bafa2f1236e-80"
                  x1="940.67"
                  y1="825.72"
                  x2="940.67"
                  y2="263.72"
                  xlinkHref="#ac3cc305-f6db-42f4-bbbd-32121ee27a74-79"
                />
              </defs>
              ...
              <path
                ...
                transform="translate(-47.24 -58.63)"
                fill="url(#ac3cc305-f6db-42f4-bbbd-32121ee27a74-79)"
              />
              <path
              ...
              <path
                ...
                transform="translate(-47.24 -58.63)"
                fill="url(#ad14f186-b27f-416c-b629-0bafa2f1236e-80)"
              />
              <polygon
